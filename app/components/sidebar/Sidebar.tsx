...
const Sidebar = ({ onFilterChange }: SidebarProps) => {
    ...
    return (
        <div className="flex flex-col space-y-4 p-4 text-lg text-gray-600 bg-white shadow-md rounded-lg">
            ...
            <div className="flex flex-col min-w-44 space-y-2">
                {categories.map((category) => (
                    <button
                        ...
                        className="text-left font-medium hover:bg-gray_secondary flex flex-row items-center space-x-2 p-2 rounded-lg"
                    >
